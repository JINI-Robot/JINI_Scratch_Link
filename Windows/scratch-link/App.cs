...
namespace scratch_link
{
    public class App : ApplicationContext
    {
        ...
        private static class SDMPath
        {
            ...
            public const string SR = "/scratch/serial";
        }
        ...
        public App()
        {
            ...
            _sessionManagers = new SortedDictionary<string, SessionManager>
            {
                ...
                [SDMPath.SR] = new SessionManager(webSocket => new SRSession(webSocket))
            };
            ...
            _server = new WebSocketServer($"ws://127.0.0.1:{SDMPort}", false)
            {
